...
public class Main {
    public static void main(String[] args) {
        ...
        //Let's add a new product to test the save method (extra)
        productRepository.save(new Product(4L, "Keyboard Thing", 10));
        ...
        orderController.handleUserRequest(1L, 10); // Should fail (insufficient stock)
        orderController.handleUserRequest(2L, 5); // Should succeed
        orderController.handleUserRequest(4L, 10); // Should fail (insufficient
    }
}
